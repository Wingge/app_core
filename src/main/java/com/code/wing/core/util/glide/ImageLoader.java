package com.code.wing.core.util.glide;
...
public class ImageLoader {
    ...
    public static ImageLoadConfig defConfig = new ImageLoadConfig.Builder().
            ...
            setAsBitmap(true).
            setPlaceHolderResId(R.drawable.default_load_img).
            setErrorResId(R.drawable.default_load_img).
...
//        if (MyGlideModule.cache != null && uri != null) {
//            MyGlideModule.cache.delete(new StringSignature(uri));
//            Glide.get(context).clearMemory();
//        }
//    }
...
//        return MyGlideModule.cache != null && uri != null ? MyGlideModule.cache.get(new StringSignature(uri)) : null;
//    }

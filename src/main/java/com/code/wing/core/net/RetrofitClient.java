...
public class RetrofitClient {
   ...
   /**
    ...
    public static void addCertificates(InputStream... certificates) {
        try {
        ...
        okHttpClient.newBuilder().socketFactory(socketFactory).build();
    ...
    /**
     * ApiBaseUrl(好像不能生效，慎用)
     *
     * @param newApiHeaders
     */
    public void changeApiHeader(Map<String, String> newApiHeaders) {
    ...
    public Subscription get(String url, Map<String, String> parameters, Subscriber<ResponseBody> subscriber) {
